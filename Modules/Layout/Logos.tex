...
% Required Packages
% ==============================================================================
\RequirePackage{tikz}          % For drawing and positioning
\RequirePackage{tikzpagenodes} % For page node references
\RequirePackage{graphicx}      % For including images
\RequirePackage{arrayjobx}     % For array handling
\RequirePackage{etoolbox}      % For \patchcmd
\RequirePackage{bophook}       % For \AtBeginPage
\RequirePackage{calc}          % For calculations with lengths
