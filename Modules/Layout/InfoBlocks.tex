...
\RequirePackage{fp}           % For FPeval floating point calculations
\RequirePackage{environ}      % For NewEnviron command
\RequirePackage{mdframed}     % For framed boxes
\RequirePackage{fontawesome5} % For icons
\RequirePackage{keyval}       % For key-value parameters
