...
% Required Packages
% ==============================================================================
\RequirePackage{listings}  % For code listings with syntax highlighting
\RequirePackage{xcolor}    % For syntax coloring
\RequirePackage{hyphenat}  % For hyphenation in monospaced fonts
