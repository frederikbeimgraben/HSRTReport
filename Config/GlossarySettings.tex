...
% Required Packages
% ==============================================================================
\RequirePackage[acronym, savenumberlist=true]{glossaries}  % For glossary and acronym lists
\RequirePackage{longtable}     % For multi-page glossary tables
\RequirePackage{array}         % For custom column types
\RequirePackage{ragged2e}      % For text alignment in tables
