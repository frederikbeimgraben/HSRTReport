...
% Required Packages
% ==============================================================================
\RequirePackage{lastpage}  % For "Page X of Y" functionality
\RequirePackage{fancyhdr}  % For headers and footers
\RequirePackage{ifthen}    % For conditional statements
\RequirePackage{xcolor}    % For color support (used for gray text)
\RequirePackage{etoolbox}  % For \ifdef command
